...
insert into public.release_artifacts (
  ...
  status, published_at, revoked_at
) values
  ('release_artifact_p02011_stable', '1.0.0', 'stable', 'linux', 'x64', 'package', 'storage://releases/p02011/otask.tar.gz', repeat('a', 64), 1024, repeat('S', 64), 'published', now(), null),
  ('release_artifact_p02011_draft', '1.0.1', 'beta', 'linux', 'x64', 'package', 'storage://releases/p02011/draft.tar.gz', repeat('b', 64), 1024, repeat('T', 64), 'draft', null, null),
  ('release_artifact_p02011_revoked', '0.9.0', 'stable', 'linux', 'x64', 'package', 'storage://releases/p02011/revoked.tar.gz', repeat('c', 64), 1024, repeat('U', 64), 'revoked', null, now());
