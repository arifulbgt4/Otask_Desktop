...
- `[IN_PROGRESS] P01-002` Define `TaskPlan` and every v1 step schema with strict additional-property rules. Local schema and graph fixtures pass; remote CI is pending.
